...
export class PunchlinesComponent {
  ...
  punchlines: string[] = [
    ...
    "Ce n'est pas un bilan de compétences façon quiz psychologique ou test de logique. Ici, on parle métier. Concret. Réel. Utile.",
    ...
    // "BE-ON-TOP est un outil d'orientation qui parle vrai, parle métier, parle terrain.",
    "BE-ON-TOP, n'est pas un simple catalogue de formations. C'est un outil pour tester vos compétences, explorer vos envies… et intégrer une formation qui vous ressemble...",
  ]
  punchline: string = "";
  rating: number = 0
